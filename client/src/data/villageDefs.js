...
const VILLAGE_DEFS = {
  ...
  saglikCadiri: { cpPerLevel:1, name:'Sağlık Çadırı',   category:'askeri', icon:'⛺', description:'Yaralı askerleri iyileştiren bina.',             unique:true, maxLevel:null, buildBaseWork:25, buildMultiplier:1.7, cost:{ kereste:60, tahil:30 } },
  ...
  // ── Ekonomik ────────────────────────────────────────────────────
  pazar:      { cpPerLevel:2, name:'Pazar',              category:'ekonomik', icon:'🏪', description:'Hammadde al-sat.',                              unique:true, maxLevel:null, buildBaseWork:40, buildMultiplier:1.8, cost:{ kereste:100, yontmaTas:80 } },
