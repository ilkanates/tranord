...
const VILLAGE_DEFS = {
  ...
  saglikCadiri: { cpPerLevel:1, name:'Sağlık Çadırı',   category:'askeri', icon:'⛺', description:'Köyün SAVUNULDUĞU savaşlarda kaybettiğin askerlerin bir kısmı yaralı sayılır ve orduna geri döner. Her seviye %2, Lvl 20 de %40. Saldırıda ölen askere işlemez — çadır köyde.',             unique:true, maxLevel:20, buildBaseWork:25, buildMultiplier:1.7, cost:{ kereste:35, tahil:30 } },
